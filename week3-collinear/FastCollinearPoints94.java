...
public class FastCollinearPoints94 {
    // finds all line segments containing 4 or more points

    private final ArrayList<LineSegment> segments = new ArrayList<>();

    public FastCollinearPoints94(Point[] points) {
        checkNull(points);
    ...
    public static void main(String[] args) {
        ...
        FastCollinearPoints94 collinear = new FastCollinearPoints94(points);
